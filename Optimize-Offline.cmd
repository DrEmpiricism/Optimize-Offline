...
IF %ERRORLEVEL% NEQ 0 (
    ...
    TIMEOUT /T 2 >NUL
    PowerShell.exe -NoProfile -ExecutionPolicy Bypass -File %~dpn0.ps1 -SourcePath "%SourcePath%" -WindowsApps "Select" -SystemApps -Capabilities -Packages -Features -DeveloperMode -Win32Calc -Dedup -Registry -DaRT "Setup", "Recovery" -Additional -ISO "No-Prompt"
)
PAUSE
EXIT