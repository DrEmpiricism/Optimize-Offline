...
FailedPackageCleanup                    = Failed to Disable Services, Drivers and Integration Content for Removed Apps.
...
FailedImportingRegistryTemplates        = Failed to Import Registry Templates.
