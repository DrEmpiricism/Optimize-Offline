...
IF %ERRORLEVEL% NEQ 0 (
    ...
    TIMEOUT /T 2 >NUL
    PowerShell.exe -NoProfile -ExecutionPolicy Bypass -File .\Optimize-Offline.ps1 -ImagePath "%SourcePath%" -Build %SourceBuild% -WhiteList -SetRegistry -AdditionalFeatures -Local
)
PAUSE
EXIT
