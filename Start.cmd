...
IF %ERRORLEVEL% NEQ 0 (
    ...
    TIMEOUT /T 2 >NUL
    PowerShell.exe -NoProfile -ExecutionPolicy Bypass -File .\Optimize-Offline.ps1 -SourcePath "%SourcePath%" -WindowsApps "Select" -SystemApps -Packages -Features -Win32Calc -Dedup -Registry -Additional -ISO "No-Prompt"
)
PAUSE
EXIT