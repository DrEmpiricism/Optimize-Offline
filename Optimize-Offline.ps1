...
$WhitelistPath = Join-Path -Path $PSScriptRoot -ChildPath "Resources\AppxPackageWhitelist.xml"
...
If ($Registry)
{
    Try
    {
        ...
        If ($WimInfo.Name -like "*LTSC") { $TelemetryLevel = 0 } Else { $TelemetryLevel = 1 }
