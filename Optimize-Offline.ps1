...
If ($OptimizeRegistry)
{
	$SECURITY_AND_PRIVACY = {
		...
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\InputPersonalization\TrainedDataStore" /v "HarvestContacts" /t REG_DWORD /d "0" /f)
		#****************************************************************
		Write-Output '' >> $WorkFolder\Registry-Optimizations.log
		...
		[void](REG ADD "HKLM\WIM_HKLM_SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" /v "SensorPermissionState" /t REG_DWORD /d "0" /f)
		...
		#****************************************************************
		Write-Output '' >> $WorkFolder\Registry-Optimizations.log
		Write-Output "Disabling Non-Explicit App Synchronization and Device Access." >> $WorkFolder\Registry-Optimizations.log
		#****************************************************************		
		...
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{2EEF81BE-33FA-4800-9670-1CD474972C3F}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{7D7E8402-7C54-4821-A34E-AEEFD62DED93}" /v "Value" /t REG_SZ /d "Deny" /f)
		...
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{9231CB4C-BF57-4AF3-8C55-FDA7BFCC04C5}" /v "Value" /t REG_SZ /d "Deny" /f)
		...
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{9D9E0118-1807-4F2E-96E4-2CE57142E196}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{A8804298-2D5F-42E3-9531-9C8C39EB29CE}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{B19F89AF-E3EB-444B-8DEA-202575A71599}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{C1D23ACC-752B-43E5-8448-8D0E519CD6D6}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{D89823BA-7180-4B81-B50C-7E471E6121A3}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{E5323777-F976-4f5b-9B55-B94699C46E44}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{E6AD100E-5F4E-44CD-BE0F-2265D88D14F5}" /v "Value" /t REG_SZ /d "Deny" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{E83AF229-8640-4D18-A213-E22675EBB2C3}" /v "Value" /t REG_SZ /d "Deny" /f)
		#****************************************************************
		Write-Output '' >> $WorkFolder\Registry-Optimizations.log
		Write-Output "Disabling Universal App Device Access." >> $WorkFolder\Registry-Optimizations.log
		#****************************************************************
		Set-Item -Path "HKLM\WIM_HKLM_SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"
		$AppsAccess = @(
		...
		) | % { Set-ItemProperty "HKLM\WIM_HKLM_SOFTWARE\Policies\Microsoft\Windows\AppPrivacy" -Name "$_" -Value 2 }
		#****************************************************************
		Write-Output '' >> $WorkFolder\Registry-Optimizations.log
		Write-Output "Disabling Background Access f." >> $WorkFolder\Registry-Optimizations.log
		#****************************************************************	
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Microsoft.PPIProjection_cw5n1h2txyewy" /v "Disabled" /t REG_DWORD /d "1" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Microsoft.PPIProjection_cw5n1h2txyewy" /v "DisabledByUser" /t REG_DWORD /d "1" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Windows.ContactSupport_cw5n1h2txyewy" /v "Disabled" /t REG_DWORD /d "1" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Windows.ContactSupport_cw5n1h2txyewy" /v "DisabledByUser" /t REG_DWORD /d "1" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Microsoft.MicrosoftEdge_8wekyb3d8bbwe" /v "Disabled" /t REG_DWORD /d "1" /f)
		[void](REG ADD "HKLM\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications\Microsoft.MicrosoftEdge_8wekyb3d8bbwe" /v "DisabledByUser" /t REG_DWORD /d "1" /f)
		#****************************************************************
		Write-Output '' >> $WorkFolder\Registry-Optimizations.log
	...
	$DEVICE_EXPERIENCE = {
		...
		{
			Set-Item -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\SettingSync\Groups\$Group"
			Set-ItemProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\SettingSync\Groups\$Group" -Name "Enabled" -Value 0
		}
...
If ($SystemAppsComplete -eq $true -and $SystemAppsList -contains "SecHealthUI")
{
	Try
	{
		...
		{
			Set-Item "$Software\Policies\Microsoft\Windows Defender"
			Set-Item "$Software\Policies\Microsoft\Windows Defender\Spynet"
			Set-Item "$Software\Policies\Microsoft\Windows Defender\Real-Time Protection"
			Set-Item "$Software\Policies\Microsoft\Windows Defender\Policy Manager"
		...
		{
			Set-Item "$Software\Policies\Microsoft\MRT"
		...
		{
			Remove-ItemProperty -Path "$Software\Microsoft\Windows\CurrentVersion\Run" -Name "SecurityHealth"
		}
...
If ($RegistryComplete -eq $true)
{
	Try
	{
		...
		{
			Set-Item "HKLM:\WIM_HKLM_SYSTEM\ControlSet001\Services\$_"
			Set-ItemProperty -Path "HKLM:\WIM_HKLM_SYSTEM\ControlSet001\Services\$_" -Name "Start" -Value 4
		}
...
# MIILcwYJKoZIhvcNAQcCoIILZDCCC2ACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYPBcaf0KtYXmEriIN0tfBXP2
# zRqgggjmMIIDaTCCAlGgAwIBAgIQb3wGgV/z161BGZ7IsR60pjANBgkqhkiG9w0B
...
# wRKGMCf0QeLfj6cOKPGi0m9yI0JfyqUzVkyJEzGCAfcwggHzAgEBMF4wRzEUMBIG
...
# 5sm1UDyK+vH876PQrUGs9iSmfRcwDQYJKoZIhvcNAQEBBQAEggEAcwstnjCy6CWW
# 3b1m5H2Oyv6UtDt8wY7XhJklcsGMmA4GbFoC35S/9C1CAh2r2jdGLJAnzQxl8j6R
# M/NrCN4eumwxrGZipE+WOYgEX2c+YR2SISPolxmkh7i/i9SrWqU0TQ+ctfka/qun
# MAwAuV0JTMnYpEpxO3aEJtiiGhJ9/PgtcBkbrEpALsu9IXehI+PkgAB7wRKyFwzw
# tUJCH1ubJGTzh348sCce5Bn6BIP8vwoHJ7vwSPFCzV+zoXlWE4/Fp0/u9gMsi0ZV
# /XQkvwJl7zaNMnZz5QcjQoaDMYnimmfowsxPJ5poNj6mPln5DhVnCUPsbRMMEy01
# 5TbS9f3MzA==
