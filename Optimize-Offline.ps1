...
If ($SetRegistry) {
    ...
    Try {
        ...
        New-Container -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}"
        New-Container -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{E6AD100E-5F4E-44CD-BE0F-2265D88D14F5}"
        ...
        $DisableSensorPerm = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Permissions\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}"
            Name  = "SensorPermissionState"
            Value = 0
            Type  = "DWord"
        }
        Set-ItemProperty @DisableSensorPerm
        $DisableSensorOverride = @{
            Path  = "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}"
            Name  = "SensorPermissionState"
            Value = 0
            Type  = "DWord"
        }
        Set-ItemProperty @DisableSensorOverride
        $DenyLocSensor1 = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}"
            Name  = "Value"
            Value = "Deny"
            Type  = "String"
        }
        Set-ItemProperty @DenyLocSensor1
        $DenyLocSensor2 = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{E6AD100E-5F4E-44CD-BE0F-2265D88D14F5}"
            Name  = "Value"
            Value = "Deny"
            Type  = "String"
        }
        Set-ItemProperty @DenyLocSensor2
        ...
        New-Container -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP\SettingsPage"
        Set-ItemProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP" -Name "CdpSessionUserAuthzPolicy" -Value 2 -Type DWord
        Set-ItemProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP" -Name "NearShareChannelUserAuthzPolicy" -Value 0 -Type DWord
        Set-ItemProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP" -Name "RomeSdkChannelUserAuthzPolicy" -Value 2 -Type DWord
        Set-ItemProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP\SettingsPage" -Name "RomeSdkChannelUserAuthzPolicy" -Value 2 -Type DWord
        #****************************************************************
        Write-Output '' >> $WorkFolder\Registry-Optimizations.log
        Write-Output "Disabling Other Devices Non-Explicitly Accessing This Device." >> $WorkFolder\Registry-Optimizations.log
        #****************************************************************
        ...
        #****************************************************************
        Write-Output '' >> $WorkFolder\Registry-Optimizations.log
        Write-Output "Disabling Apps Non-Explicitly Accessing SMS/Text, Messaging and Call History." >> $WorkFolder\Registry-Optimizations.log
        #****************************************************************
        ...
        $DenyCallHistory = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{8BC668CF-7728-45BD-93F8-CF2B3B41D7AB}"
            Name  = "Value"
            Value = "Deny"
            Type  = "String"
        }
        Set-ItemProperty @DenyCallHistory
        $DenyText = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{992AFA70-6F47-4148-B3E9-3003349C1548}"
            Name  = "Value"
            Value = "Deny"
            Type  = "String"
        }
        Set-ItemProperty @DenyText
        $DenySMS = @{
            Path  = "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{21157C1F-2651-4CC1-90CA-1F28B02263F6}"
            Name  = "Value"
            Value = "Deny"
            Type  = "String"
        }
        Set-ItemProperty @DenySMS
