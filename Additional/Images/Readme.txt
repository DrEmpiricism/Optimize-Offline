...
- Despite this, the custom lock screen will continue to display despite being replaced, as its also saved at "%ProgramData%\Microsoft\Windows\SystemData\S-1-5-18\ReadOnly\LockScreen_Z" and this takes precedence over its default location unless it's manually changed.