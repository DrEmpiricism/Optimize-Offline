Function Set-RegistryProperties
{
    ...
    Try
    {
        ...
        If($InstallInfo.Build -ge '18363' -and $SelectiveRegistry.ClassicSearchExplorer) { RegKey -Path "HKLM:\WIM_HKLM_SOFTWARE\Classes\CLSID\{1d64637d-31e9-4b06-9124-e83fb178ac6e}\TreatAs" -Name "(default)" -Value "{64bc32b5-4eec-4de7-972d-bd8bd0324537}" -Type String -Force }
        ...
        If($InstallInfo.Build -ge '22000') {
            ...
            If ($SelectiveRegistry.W11ClassicInterface) {
